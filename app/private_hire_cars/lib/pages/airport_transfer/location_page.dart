...
import 'package:private_hire_cars/pages/airport_transfer/choose_car_page.dart';
import 'package:private_hire_cars/services/location_service.dart';
import 'package:latlong2/latlong.dart';

const backgroundColor = Color(0xfff6f7f9);

class LocationAndTimePage extends StatefulWidget {
  const LocationAndTimePage({super.key, required this.title});
  final String title;

  @override
  State<LocationAndTimePage> createState() => _LocationAndTimePageState();
}

class _LocationAndTimePageState extends State<LocationAndTimePage> {
